...
export var Map = Evented.extend({
	...
	// @method project(latlng: LatLng, zoom: Number, magnetPoint: Point): Point
	// Projects a geographical coordinate `LatLng` according to the projection
	// of the map's CRS, then scales it according to `zoom` and the CRS's
	// `Transformation`. The result is pixel coordinate relative to
	// the CRS origin.
	project: function (latlng, zoom, magnetPoint) {
		zoom = zoom === undefined ? this._zoom : zoom;
		return this.options.crs.latLngToPoint(toLatLng(latlng), zoom, magnetPoint);
	},
	...
	// @method latLngToLayerPoint(latlng: LatLng, magnetPoint: Point): Point
	// Given a geographical coordinate, returns the corresponding pixel coordinate
	// relative to the [origin pixel](#map-getpixelorigin).
	latLngToLayerPoint: function (latlng, magnetPoint) {
		if (typeof magnetPoint === 'undefined') {
			magnetPoint = this.getDefaultMagnetPoint();
		}
		var projectedPoint = this.project(toLatLng(latlng), this._zoom, magnetPoint)._round();
